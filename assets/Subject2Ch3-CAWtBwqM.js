import{j as s}from"./index-D6MXpY7I.js";import{S as r}from"./SEOHead-CmNMTZbc.js";import{L as E}from"./LessonComplete-CHRT6r5O.js";import{S as d,a as e}from"./SampleDataPanel-CjAHazlZ.js";function x(){return s.jsxs("div",{className:"lesson-page",children:[s.jsx(r,{title:"3장: 관리 구문 - SQLD Study",description:"MERGE, TCL, 제약조건, DCL"}),s.jsxs("section",{className:"hero-compact","data-aos":"fade-up",children:[s.jsx("h1",{children:"3장: 관리 구문"}),s.jsx("p",{className:"hero-subtitle",children:"MERGE, TCL, 제약조건, DCL"})]}),s.jsxs("article",{className:"content-card","data-aos":"fade-up",children:[s.jsx(d,{}),s.jsx("h2",{children:"1. MERGE 문"}),s.jsxs("p",{children:["MERGE는 ",s.jsx("strong",{children:"INSERT와 UPDATE를 동시에"})," 수행하는 DML입니다. 대상 테이블에 데이터가 있으면 UPDATE, 없으면 INSERT합니다."]}),s.jsx(e,{title:"MERGE 기본 문법",sql:`MERGE INTO 대상테이블 T
USING 소스테이블 S
ON (T.키 = S.키)
WHEN MATCHED THEN
...
WHEN NOT MATCHED THEN
  ...
  VALUES (S.키, S.컬럼1, S.컬럼2);`}),s.jsx("h3",{children:"MERGE 활용 예시"}),s.jsx(e,{title:"MERGE 활용",sql:`-- 일별 매출 집계 테이블 갱신
MERGE INTO 일매출 T
...
ALTER TABLE 사원 ENABLE CONSTRAINT fk_부서;`}),s.jsx("h2",{children:"4. DCL (Data Control Language)"}),s.jsx("h3",{children:"GRANT - 권한 부여"}),s.jsx(e,{title:"GRANT",sql:`-- 시스템 권한 부여
...
GRANT SELECT ON 사원 TO user1 WITH GRANT OPTION;`}),s.jsx("h3",{children:"REVOKE - 권한 회수"}),s.jsx(e,{title:"REVOKE",sql:`REVOKE SELECT ON 사원 FROM user1;

-- CASCADE: WITH GRANT OPTION으로 전파된 권한도 함께 회수
REVOKE SELECT ON 사원 FROM user1 CASCADE;`}),s.jsx("h3",{children:"ROLE - 권한 그룹"}),s.jsx(e,{title:"ROLE",sql:`-- ROLE 생성 및 권한 부여
CREATE ROLE manager_role;
GRANT SELECT, INSERT, UPDATE ON 사원 TO manager_role;

-- 사용자에게 ROLE 부여
GRANT manager_role TO user1, user2;`}),s.jsx("h2",{children:"5. VIEW (뷰)"}),s.jsx(e,{title:"VIEW",sql:`-- 뷰 생성
...
SELECT emp_seq.CURRVAL FROM DUAL;`}),s.jsx("h3",{children:"인덱스 (INDEX)"}),s.jsx(e,{title:"INDEX",sql:`-- 인덱스 생성
...
-- 인덱스 삭제
DROP INDEX idx_사원_부서;`}),s.jsx("h3",{children:"인덱스 사용이 유리한 경우"}),s.jsxs("ul",{children:[s.jsx("li",{children:"WHERE 절에 자주 사용되는 컬럼"}),s.jsx("li",{children:"JOIN 조건에 사용되는 컬럼"}),s.jsx("li",{children:"ORDER BY에 자주 사용되는 컬럼"}),s.jsx("li",{children:"데이터 분포가 넓은(Cardinality가 높은) 컬럼"})]}),s.jsxs("div",{className:"info-box",children:[s.jsx("strong",{children:"인덱스가 불리한 경우:"}),s.jsx("br",{}),"• DML이 빈번한 테이블 (INSERT/UPDATE/DELETE 성능 저하)",s.jsx("br",{}),"• 데이터가 적은 테이블",s.jsx("br",{}),"• 대부분의 행을 조회하는 경우 (Full Scan이 유리)"]})]}),s.jsx(E,{lessonId:"subject2-ch3"})]})}export{x as default};
