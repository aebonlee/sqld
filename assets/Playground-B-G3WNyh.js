...
import{r as t,_ as w,j as e}from"./index-D6MXpY7I.js";import{S as G}from"./SEOHead-CmNMTZbc.js";function Y({datasets:u}){const[R,V]=t.useState(0),[o,i]=t.useState(""),[r,N]=t.useState(null),[m,E]=t.useState(""),[U,T]=t.useState(null),[L,f]=t.useState([]),[j,O]=t.useState(!1),[p,g]=t.useState(!1),[h,y]=t.useState(!0),c=t.useRef(null),d=t.useRef(null),A=t.useRef(null),S=u[R];t.useEffect(()=>{let s=!1;return(async()=>{try{const n=(await w(async()=>{const{default:a}=await import("./sql-wasm-browser-B9f7AkqH.js").then(I=>I.s);return{default:a}},__vite__mapDeps([0,1]))).default,l=await n({locateFile:()=>"/sql-wasm.wasm"});s||(d.current=l,x(l,u[R]))}catch(n){s||E("sql.js 초기화 실패: "+n.message)}})(),()=>{s=!0}},[]);const x=t.useCallback((s,n)=>{y(!0),N(null),E(""),T(null);try{c.current&&c.current.close();const l=new s.Database;l.run(n.createSQL),n.insertSQL.split(";").filter(a=>a.trim()).forEach(a=>l.run(a+";")),c.current=l}catch(l){E("DB 초기화 실패: "+l.message)}y(!1)},[]),v=s=>{V(s),i(""),N(null),E(""),T(null),O(!1),g(!1),d.current&&x(d.current,u[s])},C=t.useCallback(()=>{if(!c.current||!o.trim())return;E(""),N(null);const s=performance.now();try{const n=c.current.exec(o),l=performance.now();T(l-s),n.length>0?N(n[0]):N({columns:[],values:[]}),f(a=>[{sql:o.trim(),time:new Date().toLocaleTimeString()},...a].slice(0,5))}catch(n){const l=performance.now();T(l-s),E(n.message)}},[o]),b=()=>{d.current&&x(d.current,S),i(""),N(null),E(""),T(null)},M=s=>{(s.ctrlKey||s.metaKey)&&s.key==="Enter"&&(s.preventDefault(),C())},F=s=>{i(s),O(!1),A.current?.focus()},q=()=>{if(!c.current||!S)return null;const s=[];for(const n of S.tables)try{const l=c.current.exec(`SELECT * FROM ${n.name};`);s.push({name:n.name,columns:n.columns,rows:l[0]?.values||[]})}catch{s.push({name:n.name,columns:n.columns,rows:[]})}return s};return e.jsxs("div",{className:"playground-wrap",children:[e.jsx("div",{className:"playground-tabs",children:u.map((s,n)=>e.jsx("button",{className:`playground-tab${n===R?" active":""}`,onClick:()=>v(n),children:s.name},s.id))}),e.jsx("p",{className:"playground-desc",children:S.description}),e.jsxs("div",{className:"playground-schema-section",children:[e.jsxs("button",{className:"playground-schema-toggle",onClick:()=>g(!p),children:[e.jsx("span",{className:`playground-arrow${p?" open":""}`,children:"▶"}),e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:[e.jsx("ellipse",{cx:"12",cy:"5",rx:"9",ry:"3"}),e.jsx("path",{d:"M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"}),e.jsx("path",{d:"M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"})]}),"현재 데이터셋 테이블 보기"]}),p&&!h&&e.jsx("div",{className:"playground-schema-content",children:(q()||[]).map(s=>e.jsxs("div",{className:"playground-schema-table",children:[e.jsxs("h4",{children:[s.name," (",s.rows.length,"행)"]}),e.jsx("div",{className:"playground-table-wrap",children:e.jsxs("table",{className:"playground-table",children:[e.jsx("thead",{children:e.jsx("tr",{children:s.columns.map((n,l)=>e.jsx("th",{children:n},l))})}),e.jsx("tbody",{children:s.rows.map((n,l)=>e.jsx("tr",{children:n.map((a,I)=>e.jsx("td",{children:a==null?e.jsx("em",{className:"sql-null",children:"(NULL)"}):String(a)},I))},l))})]})})]},s.name))})]}),e.jsxs("div",{className:"playground-editor-section",children:[e.jsxs("div",{className:"playground-editor-header",children:[e.jsx("span",{children:"SQL 입력"}),e.jsx("span",{className:"playground-shortcut",children:"Ctrl + Enter로 실행"})]}),e.jsx("textarea",{ref:A,className:"playground-editor",value:o,onChange:s=>i(s.target.value),onKeyDown:M,placeholder:"SELECT * FROM 부서;",rows:6,spellCheck:!1})]}),e.jsxs("div",{className:"playground-toolbar",children:[e.jsxs("div",{className:"playground-toolbar-left",children:[e.jsxs("button",{className:"playground-btn playground-btn-run",onClick:C,disabled:h||!o.trim(),children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M8 5v14l11-7z"})}),"실행"]}),e.jsx("button",{className:"playground-btn playground-btn-reset",onClick:b,children:"초기화"})]}),e.jsx("div",{className:"playground-toolbar-right",children:e.jsxs("div",{className:"playground-examples-wrap",children:[e.jsx("button",{className:"playground-btn playground-btn-examples",onClick:()=>O(!j),children:"예제 SQL ▾"}),j&&e.jsx("div",{className:"playground-examples-dropdown",children:S.examples.map((s,n)=>e.jsx("button",{onClick:()=>F(s.sql),children:s.title},n))})]})})]}),h&&e.jsxs("div",{className:"playground-loading",children:[e.jsx("div",{className:"loading-spinner"})," 데이터베이스 초기화 중..."]}),m&&e.jsxs("div",{className:"playground-error",children:[e.jsx("strong",{children:"Error:"})," ",m]}),r&&!m&&e.jsxs("div",{className:"playground-result",children:[e.jsxs("div",{className:"playground-result-header",children:[e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("polyline",{points:"20 6 9 17 4 12"})}),"실행 결과",r.values?` (${r.values.length}건)`:" (0건)",U!==null&&e.jsxs("span",{className:"playground-elapsed",children:[" — ",U.toFixed(1),"ms"]})]}),r.columns&&r.columns.length>0?e.jsx("div",{className:"playground-table-wrap",children:e.jsxs("table",{className:"playground-table playground-result-table",children:[e.jsx("thead",{children:e.jsx("tr",{children:r.columns.map((s,n)=>e.jsx("th",{children:s},n))})}),e.jsx("tbody",{children:r.values.map((s,n)=>e.jsx("tr",{children:s.map((l,a)=>e.jsx("td",{children:l==null?e.jsx("em",{className:"sql-null",children:"(NULL)"}):String(l)},a))},n))})]})}):e.jsx("div",{className:"playground-no-result",children:"쿼리가 성공적으로 실행되었습니다 (반환된 행 없음)."})]}),L.length>0&&e.jsxs("div",{className:"playground-history",children:[e.jsxs("div",{className:"playground-history-title",children:["실행 히스토리 (최근 ",L.length,"개)"]}),e.jsx("ul",{children:L.map((s,n)=>e.jsx("li",{children:e.jsxs("button",{className:"playground-history-item",onClick:()=>{i(s.sql),A.current?.focus()},children:[e.jsx("code",{children:s.sql.length>80?s.sql.slice(0,80)+"...":s.sql}),e.jsx("span",{className:"playground-history-time",children:s.time})]})},n))})]})]})}const P=`CREATE TABLE 부서 (
